  ...
  loop: (unadjusted, off = false) => {
    ...
    if (game.data.bups[0][1]) {
      ...
      if (game.data.pendingMaxAll >= 1) {
        ...
        if (game.data.op < game.calcFactorShiftCost() && (game.data.challenge === 0 || game.data.op < game.chalGoals[game.data.challenge - 1][game.data.chalComp[game.data.challenge - 1]])) {
