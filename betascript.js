...
var game = {
  ...
  calcDynamicMult: (x = game.data.dynamicFactor) => x ** (game.data.bups[3][0] && game.data.challenge % 2 === 1 ? 2: 1),
  ...
  achieve: {
    ...
    achieveReq: [
      ...
      [
        ...
        () => game.data.factorShifts >= 7,
        () => game.totalFactorMult() >= 1.000e7,
        () => game.totalFactorMult() >= 1.000e9,
        () => false
      ],
      [
  ...
  render: () => { 
    ...
    if (game.data.challenge === 0) {
      ...
      game.challengeProg.innerHTML = 
        `${game.data.challenge === 2 ? game.data.chalComp[1] > 0 ? game.beautify(100 * (Math.max(1.000e230, game.data.op) - 1.000e230) / (game.chalGoals[game.data.challenge - 1][game.data.chalComp[game.data.challenge - 1]] - 1.000e230)): game.beautify(100 * Math.min(1.000e230, game.data.op) / 1.000e230): game.data.challenge === 1 && game.data.chalComp[0] === 2 ? game.beautify(100 * Math.max(1.000e230, game.data.op) / 1.000e230): game.beautify(100 * Math.min(1, game.data.op / game.chalGoals[game.data.challenge - 1][game.data.chalComp[game.data.challenge - 1]]))}%`;
      game.challengeProg.style.width = 
        `${game.data.challenge === 2 ? game.data.chalComp[1] > 0 ? 100 * (Math.max(1.000e230, game.data.op) - 1.000e230) / (game.chalGoals[game.data.challenge - 1][game.data.chalComp[game.data.challenge - 1]] - 1.000e230): 100 * Math.min(1.000e230, game.data.op) / 1.000e230: game.data.challenge === 1 && game.data.chalComp[0] === 2 ? 100 * Math.min(1.000e230, game.data.op) / 1.000e230: 100 * Math.min(1, game.data.op / game.chalGoals[game.data.challenge - 1][game.data.chalComp[game.data.challenge - 1]])}%`;
    }
  ...
  loop: (unadjusted, off = false) => {
    ...
    if (game.data.bups[0][1]) {
      ...
      if (game.data.pendingMaxAll >= 1) {
        ...
        if (game.data.op < game.calcFactorShiftCost() && (game.data.challenge === 0 || game.data.op < game.data.chalGoals[Math.max(0, game.data.challenge - 1)][game.data.chalComp[Math.max(0, game.data.challenge - 1)]])) {
