...
var game = {
  ...
  render: () => { 
    ...
    game.nextLevelText.innerHTML = `Next Ordinal Level is at ${game.currentLevel() === 37 ? `&Omega;`: game.currentLevel() === 36 ? `&psi;(way too large)`: game.writeOrd(game.ordLevels[game.currentLevel() + 1]())}`;
